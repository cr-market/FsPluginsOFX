...
| FS-LineExtraction | `LineExtraction` NF project | First-pass built |
...
- `LineExtraction` currently ports the core sampling/level/blend behavior. The
  optional NF bilateral pre-process is not implemented yet.
